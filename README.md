...
- 旧ページの文章や内容は、できるだけ変えずにまずは構築を進める
- 古いコード体系や SQL は、新しい安全なコードへ書き換える
- 重複するコードはできるだけ集約し、ファイル数を減らして編集ミスや更新コストを下げる
...
- 今後のリニューアル作業は、この README の方針に沿って進めます
- 判断に迷う点や仕様が読めない点がある場合は、そのまま進めず確認を取ります
