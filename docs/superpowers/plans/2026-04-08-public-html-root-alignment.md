...
- [ ] **Step 1: `public_html` と親側の重複を確認する**
...
- [ ] **Step 1: `ra.php` がどの `src/bootstrap.php` を読むか確認する**
- [ ] **Step 2: 必要なら `public_html` 側を読むように修正する**
- [ ] **Step 3: `/admin` `/check.php` などの導線が壊れないことを確認する**
...
- [ ] **Step 1: まず `csn` を削除する前に参照されていないことを確認する**
- [ ] **Step 2: `csn` を削除する**
- [ ] **Step 3: 親側 `templates` `src` `assets` は参照移行が終わるまで保留し、切替後に削除する**
